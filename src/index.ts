...
const APP_ID: string = "amzn1.ask.skill.675c7d8f-66b2-4502-90fa-e4ca1795cbd2";
...
const languageString = {
    'de': {
        'translation': {
            'QUESTIONS': Question.QUESTIONS_DE_DE,
            'GAME_NAME': 'Wikiquote Zitatesammlung (inoffiziell)', // Be sure to change this for your skill.
